...
#define INTV_TEMP (1u << (32 - 11))  // 1024 Hz
...
void TCMP_init() {
    ...
    ADC0.SS0.CTL.TS0 = 1;
    ADC0.SS0.TSH.TSH0 = ADC_TSH_4;
    ADC0.SS0.CTL.TS1 = 1;
    ADC0.SS0.TSH.TSH1 = ADC_TSH_4;
    ADC0.SS0.CTL.TS2 = 1;
    ADC0.SS0.TSH.TSH2 = ADC_TSH_4;
    ADC0.SS0.CTL.TS3 = 1;
    ADC0.SS0.TSH.TSH3 = ADC_TSH_4;
    ADC0.SS0.CTL.TS4 = 1;
    ADC0.SS0.TSH.TSH4 = ADC_TSH_4;
    ADC0.SS0.CTL.TS5 = 1;
    ADC0.SS0.TSH.TSH5 = ADC_TSH_4;
    ADC0.SS0.CTL.TS6 = 1;
    ADC0.SS0.TSH.TSH6 = ADC_TSH_4;
    ADC0.SS0.CTL.TS7 = 1;
    ADC0.SS0.TSH.TSH7 = ADC_TSH_4;
    ADC0.SS0.CTL.IE7 = 1;
    ADC0.SS0.CTL.END7 = 1;
    ADC0.ACTSS.ASEN0 = 1;
